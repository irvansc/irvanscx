...
const projects = [
  {
    ...
    title: "Project 1",
    description:
      "This is portfolio website built with HTML 5, CSS 3, JavaScript",
    stack: [
      {
        name: "HTML 5",
      },
  ...
  },
  {
    ...
    title: "Project 3",
    description:
      "This is a portfolio website built with Laravel, Livewire, Bootstrap and MySQL.",
    stack: [
      {
        name: "Laravel",
      },
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              xl:w-max xl:absolute  xl:justify-none"
